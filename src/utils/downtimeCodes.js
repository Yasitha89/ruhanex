...
export const DOWNTIME_CODES = [
  {
    value: "TEA_BREAK",
    label: "TEA_BREAK - Tea Break",
    type: "planned",
    plannedCategory: "standard",
  },
  {
    value: "SHIFT_START",
    label: "SHIFT_START - Shift Start / Handover",
    type: "planned",
    plannedCategory: "standard",
  },
  {
    value: "SHIFT_END",
    label: "SHIFT_END - Shift End / Handover",
    type: "planned",
    plannedCategory: "standard",
  },
  {
    value: "CODE_CHANGE",
    label: "CODE_CHANGE - Design code changes",
    type: "planned",
    plannedCategory: "standard",
  },
  {
    value: "PM",
    label: "PM - Planned Maintenance",
    type: "planned",
    plannedCategory: "additional",
  },
  {
    value: "CHANGEOVER",
    label: "CHANGEOVER - Product / Size Change",
    type: "planned",
    plannedCategory: "additional",
  },
  {
    value: "CLEANING",
    label: "CLEANING - Planned Cleaning",
    type: "planned",
    plannedCategory: "additional",
  },
  ...
  {
    value: "OTHER_PLANNED",
    label: "OTHER_PLANNED - Other Planned Activity",
    type: "planned",
    plannedCategory: "additional",
  },
  {
...
export function getDowntimeCodes(type, plannedCategory) {
  return DOWNTIME_CODES.filter(
    (item) =>
      item.type === type &&
      (type !== "planned" || item.plannedCategory === plannedCategory),
  );
}
