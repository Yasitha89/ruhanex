      ...
      media: [
        {
          ...
          option: {
            ...
            yAxis: [
              { show: mobilePrimaryAxisIndex === 0, position: "left", offset: 0, nameLocation: "end", nameGap: 8, nameTextStyle: { fontSize: 10, align: "left" }, axisLabel: { inside: true, fontSize: 9, margin: 4 }, axisTick: { inside: true } },
              { show: mobilePrimaryAxisIndex === 1, position: "left", offset: 0, nameLocation: "end", nameGap: 8, nameTextStyle: { fontSize: 10, align: "left" }, axisLabel: { inside: true, fontSize: 9, margin: 4 }, axisTick: { inside: true } },
              { show: mobilePrimaryAxisIndex === 2, position: "left", offset: 0, nameLocation: "end", nameGap: 8, nameTextStyle: { fontSize: 10, align: "left" }, axisLabel: { inside: true, fontSize: 9, margin: 4 }, axisTick: { inside: true } },
              { show: mobilePrimaryAxisIndex === 3, position: "left", offset: 0, nameLocation: "end", nameGap: 8, nameTextStyle: { fontSize: 10, align: "left" }, axisLabel: { inside: true, fontSize: 9, margin: 4 }, axisTick: { inside: true } },
              { show: mobilePrimaryAxisIndex === 4, position: "left", offset: 0, nameLocation: "end", nameGap: 8, nameTextStyle: { fontSize: 10, align: "left" }, axisLabel: { inside: true, fontSize: 9, margin: 4 }, axisTick: { inside: true } },
            ],
          },
        },
      ],
